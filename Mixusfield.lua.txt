...
local Icons = {
    -- Navigation
    home           = "rbxassetid://11293988592",
    menu           = "rbxassetid://11293988592",
    settings       = "rbxassetid://11293988592",
    search         = "rbxassetid://11293988592",
    close          = "rbxassetid://11293988592",
    minimize       = "rbxassetid://11293988592",
    maximize       = "rbxassetid://11293988592",
    chevron_down   = "rbxassetid://11293988592",
    chevron_up     = "rbxassetid://11293988592",
    chevron_right  = "rbxassetid://11293988592",
    arrow_left     = "rbxassetid://11293988592",
    arrow_right    = "rbxassetid://11293988592",
    -- Actions
    play           = "rbxassetid://11293988592",
    pause          = "rbxassetid://11293988592",
    stop           = "rbxassetid://11293988592",
    refresh        = "rbxassetid://11293988592",
    copy           = "rbxassetid://11293988592",
    edit           = "rbxassetid://11293988592",
    trash          = "rbxassetid://11293988592",
    check          = "rbxassetid://11293988592",
    plus           = "rbxassetid://11293988592",
    minus          = "rbxassetid://11293988592",
    -- Status
    info           = "rbxassetid://11293988592",
    warning        = "rbxassetid://11293988592",
    error          = "rbxassetid://11293988592",
    success        = "rbxassetid://11293988592",
    bell           = "rbxassetid://11293988592",
    -- Interface
    key            = "rbxassetid://11293988592",
    lock           = "rbxassetid://11293988592",
    unlock         = "rbxassetid://11293988592",
    eye            = "rbxassetid://11293988592",
    eye_off        = "rbxassetid://11293988592",
    user           = "rbxassetid://11293988592",
    star           = "rbxassetid://11293988592",
    heart          = "rbxassetid://11293988592",
    link           = "rbxassetid://11293988592",
    external_link  = "rbxassetid://11293988592",
    grid           = "rbxassetid://11293988592",
    list           = "rbxassetid://11293988592",
    layers         = "rbxassetid://11293988592",
    cpu            = "rbxassetid://11293988592",
    zap            = "rbxassetid://11293988592",
    code           = "rbxassetid://11293988592",
    terminal       = "rbxassetid://11293988592",
    sliders        = "rbxassetid://11293988592",
    toggle_left    = "rbxassetid://11293988592",
    toggle_right   = "rbxassetid://11293988592",
    type           = "rbxassetid://11293988592",
    keyboard       = "rbxassetid://11293988592",
    default        = "rbxassetid://11293988592",
}

local IconSystem = {}

-- Resolve an icon descriptor to a Roblox asset URL
function IconSystem.Resolve(iconDef)
    ...
    if t == "Asset" or t == "Roblox" then
        -- Direct Roblox asset ID
        if type(src) == "number" then
            return "rbxassetid://" .. tostring(src)
        end
        return tostring(src)
    elseif t == "Lucide" or t == "Feather" then
        -- Named icon lookup
...
-- Create an ImageLabel icon inside a parent, returns the label
function IconSystem.Create(parent, iconDef, size, color, zIndex)
    ...
    img.ZIndex          = zIndex
    img.Image           = IconSystem.Resolve(iconDef)
    img.Parent          = parent
    return img
end
...
function KeySystem.Create(screenGui, config, theme, onSuccess)
    ...
    eyeBtn.MouseButton1Click:Connect(function()
        ...
        -- In TextBox, actual masking isn't supported natively, so we visually indicate
        eyeIcon.Image = IconSystem.Resolve({ Type="Lucide", Source = keyHidden and "eye_off" or "eye" })
...
function Window.new(screenGui, config, theme)
    ...
    local function makeCtrlBtn(iconSrc, color, size)
        size = size or 26
        ...
        IconSystem.Create(ih, { Type="Lucide", Source=iconSrc }, UDim2.fromOffset(12,12), color or theme.TextDim, 9)
        Builder.New("UIListLayout", { HorizontalAlignment=Enum.HorizontalAlignment.Center, VerticalAlignment=Enum.VerticalAlignment.Center }, ih)
        btn.MouseEnter:Connect(function() Utility.Tween(btn, Utility.TI(0.1), { BackgroundColor3 = theme.Surface }) end)
        btn.MouseLeave:Connect(function() Utility.Tween(btn, Utility.TI(0.1), { BackgroundColor3 = theme.SurfaceAlt }) end)
        return btn
    end

    -- Search button
    self._searchBtn = makeCtrlBtn("search", theme.TextDim)
    -- Minimize button
    self._minimizeBtn = makeCtrlBtn("minimize", theme.Warning)
    -- Close button
    self._closeBtn = makeCtrlBtn("close", theme.Error)
        ...
        for id, data in pairs(self._tabs) do
            ...
            if data.iconLabel then
                Utility.Tween(data.iconLabel, Utility.TI(0.2), {
                    ImageColor3 = isActive and theme.Accent or theme.TextDim
                })
            end
        end
